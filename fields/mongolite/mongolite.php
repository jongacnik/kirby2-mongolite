...
class MongoliteField extends BaseField {
  ...
  public function __construct () {
    // connect to mongoLite db
    $this->client = new MongoLite\Client(c::get('mongolite.location', kirby()->roots()->content()));
    $this->database = $this->client->{c::get('mongolite.dbname', 'mongolite')};
  }
  ...
  public function url ($action) {
    return purl($this->model(), 'field/' . $this->name() . '/mongolite/' . $action);
  }  
